...
from yogh.api.client import GITHUB_API_URL_V4
from yogh.yogh.settings import ScrumReportSettings
from yogh.tests.mocks.mock_settings import temporary_settings, mock_settings, temporary_scrum_report
...
@responses.activate
@patch("yogh.utils.dateutils._utcnow", return_value=datetime(2019, 7, 10, 1, 15, 59, 666))
