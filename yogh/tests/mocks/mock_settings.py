...
def temporary_scrum_report():
    ...
    with tempfile.NamedTemporaryFile() as scrum_report_file:
        ...
        with patch("yogh.yogh.settings.get_scrum_report_path", return_value=scrum_report_file.name):
            yield
...
def temporary_settings():
    ...
    with tempfile.NamedTemporaryFile() as settings_file:
        ...
        with patch("yogh.yogh.settings.get_settings_path", return_value=settings_file.name):
            yield
